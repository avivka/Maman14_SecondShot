...
int			from_line_to_bmc	(line*, int, list*, char*);				/* The main function of creation binary machine code */
short int	create_basic_bmc	(line*, int*, char*);					/* Creates the first binary machine code from operation */
short int 	from_src_des_opr	(line*, list*, boolean, int*, char*);	/* Use to check if the operand is SRC to DES and by the case call the right function */
